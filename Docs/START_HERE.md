...
1. **[README-TESTING.md](README-TESTING.md)**
   - How to run tests
   - Test categories
   - Coverage setup
   - Mocking patterns
...
### Documentation
- ? **11 guides** - Comprehensive
- ? **25,000+ words** - Detailed
...
dotnet test /p:CollectCoverage=true  # With coverage
```
**Reference:** [README-TESTING.md](README-TESTING.md)
...
### ?? Want to Test?
? **[README-TESTING.md](README-TESTING.md)** (30 minutes)
